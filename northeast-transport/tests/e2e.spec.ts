...
test.describe('Booking Flow', () => {
  ...
  test('shows location suggestions when typing', async ({ page }) => {
    await page.goto('/booking')
    await page.getByPlaceholder('Pickup location').fill('Guwahati')
  ...
  test('shows price estimates for all vehicles', async ({ page }) => {
    await page.goto('/booking')
  ...
  test('shows booking confirmation with price', async ({ page }) => {
    await page.goto('/booking')
    ...
    await expect(page.getByText('Base fare')).toBeVisible()
...
test.describe('Customer Dashboard', () => {
  ...
  test('shows mock bookings', async ({ page }) => {
    await page.goto('/dashboard/customer')
    await expect(page.getByText('Tata Yodha')).toBeVisible()
  })
})
...
test.describe('Driver Documents', () => {
  test('renders document upload page', async ({ page }) => {
    ...
    await expect(page.getByText('Vehicle Insurance')).toBeVisible()
  })
})
